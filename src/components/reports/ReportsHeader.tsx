...
import { 
  FileText, Plus, BarChart3, Download, 
...
const ReportsHeader: React.FC<ReportsHeaderProps> = ({ activeTab, onTabChange }) => {
  const tabs = [
    { id: 'overview', label: 'Reports Overview', icon: FileText, count: '1,247' },
    { id: 'generator', label: 'Report Generator', icon: Settings, count: 'New' },
    { id: 'scheduled', label: 'Scheduled Reports', icon: Calendar, count: '45' },
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          <div className="mb-6 lg:mb-0">
            <div className="flex items-center space-x-4 mb-4">
              <div className="w-16 h-16 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 mt-1">
                  Generate, schedule, and analyze comprehensive system reports
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-600 dark:text-gray-400">1,189 Generated</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 bg-blue-500 rounded-full animate-pulse"></div>
                <span className="text-sm text-gray-600 dark:text-gray-400">45 Scheduled</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 bg-purple-500 rounded-full animate-pulse"></div>
                <span className="text-sm text-gray-600 dark:text-gray-400">Real-time Analytics</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-3">
            <button className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl hover:shadow-lg hover:scale-105 transition-all duration-300 group">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-4 mt-4">
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input
              type="text"
              placeholder="Search reports by name, type, or date range..."
              className="w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-300"
            />
          </div>
