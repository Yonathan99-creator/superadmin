...
import { 
  Star, Plus, BarChart3, Download, 
  Search, Filter, Zap, Shield, Award,
  TrendingUp, Users, Eye, Settings,
...
const ReviewsHeader: React.FC<ReviewsHeaderProps> = ({ activeTab, onTabChange }) => {
  const tabs = [
    { id: 'overview', label: 'Reviews Overview', icon: Star, count: '12,340' },
    { id: 'moderation', label: 'Moderation Queue', icon: Shield, count: '47' },
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 mb-6">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          <div className="mb-6 lg:mb-0">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 mt-1">
                  Monitor, moderate, and analyze customer reviews and ratings
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-600 dark:text-gray-400">12,293 Approved</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 bg-yellow-500 rounded-full animate-pulse"></div>
                <span className="text-sm text-gray-600 dark:text-gray-400">47 Pending</span>
              </div>
              <div className="flex items-center space-x-2">
          ...
          <div className="flex flex-wrap gap-3">
            <button className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-yellow-600 to-orange-600 text-white rounded-xl hover:shadow-lg hover:scale-105 transition-all duration-300 group">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-4 mt-4">
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input
              type="text"
              placeholder="Search reviews by customer, professional, rating, or content..."
              className="w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all duration-300"
            />
          </div>
