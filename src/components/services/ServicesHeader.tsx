...
import { 
  Settings, Plus, BarChart3, Download, 
...
const ServicesHeader: React.FC<ServicesHeaderProps> = ({ activeTab, onTabChange }) => {
  const tabs = [
    { id: 'overview', label: 'Services Overview', icon: Settings, count: '1,247' },
          ...
          <div className="mb-6 lg:mb-0">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 mt-1">
                  Manage all platform services, categories, and pricing
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-600 dark:text-gray-400">1,189 Active</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 bg-yellow-500 rounded-full animate-pulse"></div>
                <span className="text-sm text-gray-600 dark:text-gray-400">58 Pending</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 bg-blue-500 rounded-full animate-pulse"></div>
                <span className="text-sm text-gray-600 dark:text-gray-400">15 Categories</span>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300"
            />
          </div>
